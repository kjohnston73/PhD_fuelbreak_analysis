...
drop1(M3.full)
# drop graze
M3.full <- lmer(gap_mean ~ aspect_card + sand + clay + ELEVATION +
                  imazapic_binary + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
...
drop1(M3.full)
## drop aspect
M3.full <- lmer(gap_percent_lt25 ~ graze + sand + clay + ELEVATION +
                  imazapic_binary + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop clay
M3.full <- lmer(gap_percent_lt25 ~ graze + sand + ELEVATION +
                  imazapic_binary + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop sand
M3.full <- lmer(gap_percent_lt25 ~ graze + ELEVATION +
                  imazapic_binary + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
...
drop1(M3.full)
## drop sand
M3.full <- lmer(gap_percent_25_50 ~ graze + clay + ELEVATION +
                  imazapic_binary + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop imazapic 
M3.full <- lmer(gap_percent_25_50 ~ graze + clay + ELEVATION + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
...
drop1(M3.full)
## drop imazapic 
M3.full <- lmer(gap_percent_101_200 ~ aspect_card + graze + sand + clay + ELEVATION + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop aspect 
M3.full <- lmer(gap_percent_101_200 ~ graze + sand + clay + ELEVATION + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop elevation 
M3.full <- lmer(gap_percent_101_200 ~ graze + sand + clay + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop graze
M3.full <- lmer(gap_percent_101_200 ~ sand + clay + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
...
drop1(M3.full)
## drop clay
M3.full <- lmer(gap_percent_gt200 ~ aspect_card + graze + sand + ELEVATION +
                  imazapic_binary + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop graze
M3.full <- lmer(gap_percent_gt200 ~ aspect_card + sand + ELEVATION +
                  imazapic_binary + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
...
drop1(M3.full)
## drop imazapic
M3.full <- lmer(gap_percent ~ aspect_card + graze + sand + clay + ELEVATION + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop graze
M3.full <- lmer(gap_percent ~ aspect_card + sand + clay + ELEVATION + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop sand
M3.full <- lmer(gap_percent ~ aspect_card + clay + ELEVATION + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
