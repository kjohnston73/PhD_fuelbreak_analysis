...
drop1(M3.full)
#drop graze 
M3.full <- lmer(IAG ~ aspect_card + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
# #drop sand 
M3.full <- lmer(IAG ~ aspect_card + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
# #drop elev
M3.full <- lmer(IAG ~ aspect_card + clay + imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
