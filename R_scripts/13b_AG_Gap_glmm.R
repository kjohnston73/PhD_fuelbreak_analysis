...
data <- subset(cover_gap, graze =='A' | graze == 'AA')

# GLMM process
# Step 1 - linear regression
M1 <- lm(gap_mean_log ~ aspect_card + graze + sand + clay + ELEVATION +
...
# Step 2 - fit the gls
M2 <- gls(gap_mean_log ~ aspect_card + graze + sand + clay + ELEVATION +
            imazapic_binary + year, 
          method = "ML", data = data)
summary(M2)
AIC(M2) # 15.25375
...
M3 <- lmer(gap_mean ~ aspect_card + graze + sand + clay + ELEVATION +
...
M3.full <- lmer(gap_mean ~ aspect_card + graze + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
#drop aspect
M3.full <- lmer(gap_mean ~ graze + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
#drop clay
M3.full <- lmer(gap_mean ~ graze + sand + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
#drop imazapic_binary
...
## gap_percent_lt25
M3.full <- lmer(gap_percent_lt25 ~ aspect_card + graze + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop graze
M3.full <- lmer(gap_percent_lt25 ~ aspect_card + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop imazapic
M3.full <- lmer(gap_percent_lt25 ~ aspect_card + sand + clay + ELEVATION + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
...
## gap_percent_25_50
M3.full <- lmer(gap_percent_25_50 ~ aspect_card + graze + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop aspect 
M3.full <- lmer(gap_percent_25_50 ~ graze + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop elevation 
M3.full <- lmer(gap_percent_25_50 ~ graze + sand + clay + 
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop graze 
M3.full <- lmer(gap_percent_25_50 ~ sand + clay + imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## 
...
## gap_percent_51_100
M3.full <- lmer(gap_percent_51_100 ~ aspect_card + graze + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop sand 
M3.full <- lmer(gap_percent_51_100 ~ aspect_card + graze + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop graze 
M3.full <- lmer(gap_percent_51_100 ~ aspect_card + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop elevation 
M3.full <- lmer(gap_percent_51_100 ~ aspect_card + clay + imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
...
## gap_percent_101_200
M3.full <- lmer(gap_percent_101_200 ~ aspect_card + graze + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop aspect 
M3.full <- lmer(gap_percent_101_200 ~ graze + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop imazapic 
...
## gap_percent_gt200
M3.full <- lmer(gap_percent_gt200 ~ aspect_card + graze + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop aspect 
M3.full <- lmer(gap_percent_gt200 ~ graze + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop clay 
M3.full <- lmer(gap_percent_gt200 ~ graze + sand + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop sand 
M3.full <- lmer(gap_percent_gt200 ~ graze + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop elevation 
M3.full <- lmer(gap_percent_gt200 ~ graze + imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)


## gap_percent
M3.full <- lmer(gap_percent ~ aspect_card + graze + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop aspect
M3.full <- lmer(gap_percent ~ graze + sand + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop sand
M3.full <- lmer(gap_percent ~ graze + clay + ELEVATION +
                  imazapic_binary + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
## drop imazapic
M3.full <- lmer(gap_percent ~ graze + clay + ELEVATION + year + (1 | plot), REML = TRUE, data = data)
drop1(M3.full)
