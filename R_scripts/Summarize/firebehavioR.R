...
plotFuelModels<- read.csv(file = 'data/special_input_csvs/plotFuelModels.csv') 
...
write.csv(firebehavior_outputs, file = 'data/output_sum_data_csvs/firebehavior.csv', row.names = FALSE)
...
#Fischer, and JAK. Snell. 1979. User's guide to debris prediction and hazard 
